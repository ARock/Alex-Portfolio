...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<script src="<?php echo get_template_directory_uri(); ?>/library/js/basic-jquery-slider.js" type="text/javascript"></script>
		  <script>
	...
	<body <?php body_class(); ?>>
		...
		<script>(function(d, s, id) {
		  ...
		  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=212281168870575";
		...
		<div id="container">
			...
			<header role="banner">
				...
				<div id="inner-header" class="clearfix">
					...
					<a href="<?php echo home_url(); ?>"><span id="site-logo"></span></a>
